  ...
  <q-page>
    <div class="row q-pa-sm">
      ...
      <div v-else class="col-12">
        <q-list bordered separator>
          <q-item 
            v-for="(form, key) in contactFormList"
            :key="key"
          >
            ...
            <q-item-section>
              <q-item-label> <b>Nombre: </b> {{ form.name }} {{ form.last_name }} | <b>Email: </b> {{ form.email }} | <b>Telefono: </b>{{ form.phone }} | <b>Pais: </b>{{ form.country }} </q-item-label>
              <q-item-label caption> <b>Mensaje: </b> {{ form.message }} </q-item-label>
            </q-item-section>

export default {
  ...
  normTypes: "Tipos norma",
  documentTypes: "Tipos de documento",
  normType: "Tipo norma",
  normName: "Nome norma",
  version: "Versão",
  lastUpdate: "Data da última atualização no site",
  filename: "Arquivo",
  ...
  normTypeInfo: "Informações sobre o tipo de norma",
  normTypeSection: "Seção: tipo de norma",
  normTypeList: "Lista de tipos de normas",
  normTypeUpdate: "Editar tipo de norma",
  documentTypeList: "Lista de tipos de documento",
  ...
  "Programas": "Programas",
  "Presentaciones Comerciales": "Apresentações Comerciais",
  "Folletos": "Folhetos",
  "Norma": "Norma",
  "Guía": "Guia",
  "Manual": "Manual",
  ...
  "VMO": "VMO",
  "Gestión de Operaciones con Clientes": "Gestão de Operações de Clientes",

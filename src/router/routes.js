const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "tipo_documento",
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Documents/Documents.vue"),
      },
      {
        ...
        props: true,
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Documents/Info.vue"),
      },
      {
        path: "tipo_documento/create",
        name: "tipo_documento_create",
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Documents/Create.vue"),
      },
      {
        ...
        props: true,
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Documents/Edit.vue"),
      },
      {
        path: "tipo_norma",
        name: "tipo_norma",
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Norms/Norms.vue"),
      },
      {
        ...
        props: true,
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Norms/Info.vue"),
      },
      {
        path: "tipo_norma/create",
        name: "tipo_norma_create",
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Norms/Create.vue"),
      },
      {
        ...
        props: true,
        meta: { requiresAuth: true },
        component: () => import("src/pages/Downloads/Norms/Edit.vue"),
      },
    ],
  },
